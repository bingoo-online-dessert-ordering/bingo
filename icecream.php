...
<ul>
  ...
  <li><a href="icecream.php" style="background-color: white; color: grey">Ice Creams</a></li>
...
<?php
  ...
  $retrieving_data = "select * from eatery_details where e_type='icecream' order by e_rating DESC";
  $result = $conn->query($retrieving_data);
    while($row = $result->fetch_assoc()) { ?>
      <div id="list">
      <img id="img<?= $i ?>" src="./images/icecream<?= $i ?>.jpg" alt="cake" class="rep_img" >
